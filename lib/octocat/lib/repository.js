...
var GitRef = require('./gitRef');
var GitCommit = require('./gitCommit');
var GitBlob = require('./gitBlob');
...
Repository.prototype.gitRef = model.getter(GitRef);
Repository.prototype.gitCommit = model.getter(GitCommit);
Repository.prototype.gitBlob = model.getter(GitBlob);
